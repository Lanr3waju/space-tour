...
function Destinations(props) {
    const spaceDestinations = ['moon', 'mars', 'europa', 'titan'];
    ...
    const DestinationSpaceEl = spaceDestinations.map((destinations) => (
        <DestinationSpace key={destinations} destination={destinations} activeDestination={activeDestination} setActiveDestination={setActiveDestination} />
    ));

    return (
        <div className="flex  p-4">
            <img className='h-80 w-80 ml ml-52 mt-16 animate-spin-v-slow' src={image} alt="Planet" />
