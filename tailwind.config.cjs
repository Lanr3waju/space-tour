  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        'destination-tablet': "url(/src/images/destination/background-destination-tablet.jpg)",
        'destination-mobile': "url(/src/images/destination/background-destination-mobile.jpg)",
        ...
        'technology-desktop': "url(/src/images/technology/background-technology-desktop.jpg)",
        'technology-tablet': "url(/src/images/technology/background-technology-tablet.jpg)",
        'technology-mobile': "url(/src/images/technology/background-technology-mobile.jpg)",
